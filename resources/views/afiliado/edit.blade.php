                ...
                {!! Form::open(['route' => [$path_controller.'.update',$id],'method' => 'PATCH','class'=>'form-horizontal confirm','role'=>'form','enctype'=>'multipart/form-data']) !!}
                    <div class="box-body">
                        <div class="form-group{{ $errors->has('item') ? ' has-error' : '' }}">
                            <label for="item" class="col-md-4 control-label">* NUMERO MATRICULA :</label>

                            <div class="col-md-6">
                                <input id="item" type="number" class="form-control upper" name="item" value="{{ $datos->item }}" autocomplete="off" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('nombres') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="nombres" type="text" class="form-control upper" name="nombres" value="{{ $datos->nombres }}" autocomplete="off" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('apellidos') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="apellidos" type="text" class="form-control upper" name="apellidos" value="{{ $datos->apellidos }}" autocomplete="off" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('ci') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="ci" type="text" class="form-control upper" name="ci" value="{{ $datos->ci }}" autocomplete="off" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('direccion') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="direccion" type="text" class="form-control upper" name="direccion" value="{{ $datos->direccion }}" autocomplete="off" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('fecha_nacimiento') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="fecha_nacimiento" type="date" class="form-control" name="fecha_nacimiento" value="{{ $datos->fecha_nacimiento }}" autocomplete="off" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('telefono') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="telefono" type="text" class="form-control" name="telefono" value="{{ $datos->telefono }}" autocomplete="off" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('correo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="correo" type="email" class="form-control" name="correo" value="{{ $datos->correo }}" autocomplete="off" autofocus>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control selectpicker" name="institucion" id="institucion" data-live-search="true">
                                    ...
                                    @foreach($institucion as $key=>$item)
                                        @if($datos->id_institucion==$item->id)
                        ...
                        <div class="form-group{{ $errors->has('fecha_afiliacion') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="fecha_afiliacion" type="date" class="form-control" name="fecha_afiliacion" value="{{$datos->fecha_afiliacion}}"  autofocus>
                        ...
                        <div class="form-group{{ $errors->has('fecha_titulacion') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="fecha_titulacion" type="date" class="form-control" name="fecha_titulacion" value="{{$datos->fecha_titulacion}}" autofocus>
                        ...
                        <input type="text" name="id_aporte" value="{{$datos->afiliado_aporte[0]->id}}" hidden>
                        <div class="form-group{{ $errors->has('fecha_vencimiento') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="fecha_vencimiento" type="date" class="form-control" name="fecha_vencimiento" onchange="handler(event);" value="{{$datos->afiliado_aporte[0]->plazo}}" >
...
@push('scripts')
<script >
    $('#fecha_vencimiento').select(function(){
            var Mcantidad = $('#fecha_vencimiento').val()
            $('#aporte_anual').val(Mcantidad);
    })

    function handler(e){
        var inicio = $('#fecha_afiliacion').val()
        var fin = $('#fecha_vencimiento').val()
        console.log(inicio);
        var fecha1 = moment(inicio);
        var fecha2 = moment(fin);

        var dif=fecha2.diff(fecha1, 'months');

        //console.log(fecha2.diff(fecha1, 'months'), ' dias de diferencia');
        var aporte_mensual = $('#aporte_mensual').val()
        $('#aporte_anual').val(dif*aporte_mensual);
    }
