                ...
                {!! Form::open(['route' => $path_controller.'.store', 'method'=> 'POST','class'=> 'form-horizontal confirm','role'=>'form','enctype'=>'multipart/form-data'] ) !!}    
                    <div class="box-body">
                        ...
                        <div class="form-group{{ $errors->has('correo_electronico') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="correo_electronico" type="email" class="form-control" name="correo_electronico" value="{{ old('correo_electronico') }}" placeholder="Ejemplo: roxana@gmail.com" autocomplete="off" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('usuario') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="usuario" type="text" class="form-control" name="usuario" value="{{ old('usuario') }}" autocomplete="off" autofocus>
