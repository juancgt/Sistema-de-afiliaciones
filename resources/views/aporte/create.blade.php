                ...
                {!! Form::open(['route' => $path_controller.'.store', 'method'=> 'POST','class'=> 'form-horizontal confirm','role'=>'form'] ) !!}    
                    <div class="box-body">
                        <div class="form-group{{ $errors->has('motivo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="motivo" type="text" class="form-control upper" name="motivo" value="{{ old('motivo') }}" autocomplete="off" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('monto') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="monto" type="text" class="form-control upper" name="monto" value="{{ old('monto') }}" autocomplete="off" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('plazo') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="plazo" type="date" class="form-control upper" name="plazo" value="{{ old('plazo') }}" autocomplete="off" autofocus>
