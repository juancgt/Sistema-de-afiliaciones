          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right">
                ...
                <a class="btn btn-sm btn-danger" href="{{ url('deudores') }}" target="_blank" role="button">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$item->ci_nit}}</td>
                        <td>
                        @if($model->estado_cliente($item->id_persona)>0)
                          Deudor
                        @else
                          Saldado
                        @endif
                        ...
                        <td class="text-center">
                            ...
                            <a class="btn btn-info btn-info" href="{{ route($path_controller.'.show', $item->id_persona) }}" alt="Mostar"><i class="fa fa-eye"></i></a>
